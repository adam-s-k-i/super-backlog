...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Section 01 shows exactly one Backlog button
- [ ] #2 Hub starts/reuses backlog browser per project and kills it on close
- [ ] #3 Modal shows the embedded backlog UI with close and open-in-tab
- [ ] #4 /api/run is removed
<!-- AC:END -->
